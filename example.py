...
print("One Document:", np.dot([topic_dist], phi))

# 保存
py_scvb0.save("test.dat")

# 読み込み
py_scvb02 = PyScvb0(3, 1., 1., n_iter=1000, batch_size=len(corpus))
py_scvb02.load("test.dat")
topic_dist = py_scvb02.transformSingle([(0, 1), (1, 2), (2, 3)])
print("loaded one Document:", np.dot([topic_dist], phi))
